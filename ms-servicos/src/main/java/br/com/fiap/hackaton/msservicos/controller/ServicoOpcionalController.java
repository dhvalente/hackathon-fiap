...
public class ServicoOpcionalController {
  ...
  @GetMapping
  @Operation(
      summary = "Listar serviços e opcionais",
      description = "LIsta paginada de serviços e opcionais")
  public ResponseEntity<Page<ServicoOpcionalResponse>> listarTodos(
  ...
  @PostMapping
  @Operation(
      summary = "Cadastro de serviços e opcionais",
      description = "cadastro de serviços e opcionais")
  ...
  @PutMapping("/{id}")
  @Operation(
      summary = "Atualizar cadastro de serviços e opcionais",
      description = "Atualizar cadastro de serviços e opcionais")
  ...
  @DeleteMapping("/{id}")
  @Operation(
      summary = "Deletar de serviços e opcionais",
      description = "Deletar por id o cadastro de serviços e opcionais")
  ...
  @GetMapping("/{id}")
  @Operation(
      summary = "Busca de serviços e opcionais",
      description = "Busca de serviços e opcionais por ID")
  ...
  @Operation(
      summary = "Busca de serviços e opcionais",
      description = "Busca de serviços e opcionais por Nome")
